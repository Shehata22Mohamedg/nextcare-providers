...
export default function AppHeader({ searchQuery, onSearchChange }: AppHeaderProps) {
  ...
  return (
    <header className="bg-primary text-primary-foreground shadow-lg sticky top-0 z-40">
      <div className="container mx-auto px-3 py-3 sm:px-4 sm:py-4 flex flex-col gap-2">
        <div className="flex items-center gap-2 sm:gap-4">
          <h1 className="text-base sm:text-xl font-bold tracking-tight whitespace-nowrap flex-1">
            {t("appTitle")}
          </h1>
